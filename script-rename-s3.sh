...
# 25/02/2021 - MELHORIA NA EXIBICAO DO CONTADOR        #
########################################################
...
do
  ...
  echo "$var_counter/$var_num_linhas - movendo arquivo de s3://$var_bucket_origem/$var_origem para s3://$var_bucket_destino/$var_destino..."
